...
mcp = FastMCP(
    name="ShellSidekick", on_duplicate_tools="error"  # Strict mode: prevent duplicate tool names
)

# Import tools to register them with the MCP server
# This must happen after mcp is initialized
from shellsidekick.mcp.tools import (
    detection,  # noqa: E402, F401
    history,  # noqa: E402, F401
    session,  # noqa: E402, F401
)
